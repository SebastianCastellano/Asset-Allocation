function frontier = PortfolioFrontier_RiskMng_opt(m, c, grid_number,...
...
covariance_matrix = zeros(assets_number,assets_number);
covariance_matrix(1:end-1,1:end-1) = c;
